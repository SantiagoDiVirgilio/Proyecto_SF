	...
	<div class="tablas">
            ...
            <table>
                <thead>
                    ...
                    <tr>
                        <td style="text-align: center;"><a href="añadir_formu.php?id_deporte=<?php echo $var_deportes["id_deporte"];?>">AÑADIR NUEVO</a></td>
                    </tr>
                </table>
                ...
                <table>
                    ...
                    <tr>
                        <td><?php echo $var_deportes["id_deporte"];?></td>
                        <td><?php echo $var_deportes["nombre"];?></td>
                        <td><?php echo $var_deportes["descripcion"];?></td>
                        <td><?php echo $var_deportes["cupo_maximo"];?></td>
                        <td>
                            <a class="btn-ver-horarios" href="darbaja_deporte.php?id_deporte=<?php echo $var_deportes["id_deporte"];?>">Eliminar</a>
                        </td>
                    </tr>
                    <?php }?>
                </table>
