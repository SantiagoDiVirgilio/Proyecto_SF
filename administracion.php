...
<!-- Llamamos a la base de datos para que cargue tanto, el tipo de deporte como las canchas de dicho 
        ...
        <?php
          ...
          echo"<br>";
          echo "Ingresaste como ".$variable_usu["rol"];
        }
          ?>
          </h2>
                ...
                <?php if($variable_2["nombre"] != NULL){?>
                    <div class="deporte-card">
                        ...
                        <div class="deporte-card-body">
                            ...
                            <button class="btn-ver-horarios" data-cancha-id="<?php echo $variable_2['nombre']; ?>" data-cancha-nombre="<?php echo htmlspecialchars($variable_2['nombre'], ENT_QUOTES); ?>">Acceder</button>
                        </div>
                    </div>
                <?php }?>
            <?php }?>
