...
<article>
   ...
   $id=$_SESSION['ID'];
    ...
    $resultado_1 = mysqli_query($conexion, "SELECT * FROM canchas");
    ?>
</article>

<article class="perfil">
        <h2> Nombre: <?php echo $_SESSION['nombre']; ?>
         <br>Rol de Usuario: <?php echo $_SESSION['rol']; ?>
         <br>Mail: <?php echo $_SESSION['email']; ?>
...
<?php 
    if ($_SESSION['rol'] == 'administrador'){?>
        <h3 class="perfil"> <br><br>TIPO DE PERFIL: <?php echo $_SESSION['rol']; ?><br> </h3>
<div class="wrap">
		<ul class="tabs">
...
<?php } else{?>
        <h3 class="perfil"> <br><br><?php echo $_SESSION['rol']; ?><br> </h3>
